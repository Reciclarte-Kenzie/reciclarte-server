...
```json
{
  ...
  "materials": ["Jeans", "Régua", "Linha", "Caneta", "Papel"],
  "categories": ["Bolsa", "Reciclagem", "Roupa"],
  "estimatedCost": 10,
  "difficultyLevel": 4
}
```
...
[
  ...
  },
  {
    ...
    "materials": ["Palito", "Lata", "Fita dupla face", "Renda"],
    "categories": ["Jarro", "Reciclagem", "Fofo"],
    "estimatedCost": 5,
    "difficultyLevel": 1
  }
]
...
```
/ideas?difficultyLevel=1&difficultyLevel=3&difficultyLevel=5
```
...
```
/ideas?ordered_field=estimatedCost
```
...
```
/ideas?ordered_field=difficultyLevel&ordered_direction=desc
```
...
```
/ideas?maximum_cost=10&difficultyLevel=1&ordered_field=difficultyLevel&ordered_direction=desc
```
...
```json
["Móveis", "Fofo", "Clean", "Darkwave", "Colorido"]
```
